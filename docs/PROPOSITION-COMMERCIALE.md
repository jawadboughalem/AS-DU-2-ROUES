...
- un avis écrit à la livraison, si le travail vous satisfait.
...
## 7. Déroulement et délais

| Étape | Ce qui se passe | Qui | Délai |
|---|---|---|---|
...
- **Garantie :** correction gratuite de tout dysfonctionnement pendant 30 jours
  après la mise en ligne.
- **Retouches :** 2 séries incluses. Au-delà, 60 €/h sur accord préalable.
- **Contenus :** si les textes et photos ne sont pas fournis dans un délai de
  3 semaines, le projet est mis en pause et reprend d'un commun accord.
...
Une question sur un point précis ? Appelez-moi, c'est plus simple qu'un e-mail.
